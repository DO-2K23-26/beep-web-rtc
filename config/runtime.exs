...
#
#     PHX_SERVER=true bin/webrtclixir start
#
...
config :webrtclixir, ice_port_range: read_ice_port_range!.()
...
if config_env() == :prod do
  ...
  config :webrtclixir, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
